        ...
        return Wrap(
          ...
          children: images
            ...
            .map<Widget>((entry) => GestureDetector(
              onTap: Feedback.wrapForTap(
                () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => ImagePlayerPage(
                    images: images.map<ImageEntity>((image)=>image.original).toList(),
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, _ViewModel>(
      converter: (store) => _ViewModel(
        creator: store.state.user.users[widget.post.creatorId.toString()] ?? UserEntity(),
